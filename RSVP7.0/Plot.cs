...
namespace RSVP7._0
{
    class Plot
    {
        ...
        //    // auc calculation
        //    fp = tp = 0;
        //    float fp_prev = 0, tp_prev = 0;
        //    float auc = 0;
        //    i = 0;
        //    float fpre = -10000000000;
        //    while (i < size-1)       // size 已经加过2了
        //    {
        //        if (org[i].score != fpre)
        //        {
        //            auc += trapezoid_area(fp, fp_prev, tp, tp_prev);
        //            fpre = (float)org[i].score;
        //            fp_prev = fp;
        //            tp_prev = tp;
        //        }
        //        if (org[i].label == posLabel)
        //        {
        ...
        //        }
        //    }
        //    auc += trapezoid_area(1,fp_prev,1,tp_prev);
        //    auc /= (Pnum * Nnum);
        //    return auc;
        //}
